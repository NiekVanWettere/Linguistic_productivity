...
# Part 1: Analysis of dataset [individual attestations X variables]
<br>
...
## 2. Type-Frequency List (Zipf ranking)
<br>
...
## 4. Empirical vocabulary growth curve
<br>
...
## 6. Summary of all productivity measures
<br>
...
## 7. Productivity measures within categories
<br>
...
plot(list_empirical_vgc[[3]], vgc_lnre, N0=N(lnre), legend=c("observed", "fZM"), xlim= c(0,1000), main = "Vocabulary Growth")
```
...
# Part 2: Analysis of dataset with productivity measures
<br>
...
## 2. Correlations between productivity measurements
<br>
...
## 3. Regression for count data: negative binomial
<br>
...
```{r}
nbGLM <- glm.nb(hapax_freq ~ avg_summit_10 + diff_r1_r2 + offset(log(token_freq_sample)), data=data_bis)
summary(nbGLM)
```
`<br>
